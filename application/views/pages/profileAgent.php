...
<div class="div-image1">
		...
		<?php  
               foreach($this->a->fetchtable_agent() as $row)  
                {  
                    //name has to be same as in the database.  
                	if($row->A_Mail == $this->session->item){
             ?>   	
		...
		<div style="display: inline; width: 100%">
			<div style="width: 20%; margin-left: 9%; float: left; display: inline-block;">
				...
				<h6 style="text-align: left"><i class="fas fa-user"></i><?php echo " ".$row->Registered_Name;?></h6>
			</div>
			<div style="width: 20%; margin-left: 9%; float: left; display: inline-block;">
				...
				<h6 style="text-align: left"><i class="far fa-paper-plane"></i><?php echo " ".$row->A_Mail;?></h6>
			</div>
		...
		<div style="display: inline; width: 100%; margin-left: 20%;margin-right: 5%">
			...
			<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/leanevent.css">
			<?php echo form_open('Profile/profile_Agent'); ?>

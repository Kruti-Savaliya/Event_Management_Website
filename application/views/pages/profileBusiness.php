...
<div class="div-image1">
		...
		<?php  echo $this->session->item;
               foreach($this->a->fetchtable_business() as $row)  
                {  
                    //name has to be same as in the database.  
                	if($row->O_Mail == $this->session->item){
             ?>
		...
		<div style="display: inline; width: 100%">
			<div style="width: 20%; margin-left: 9%; float: left; display: inline-block;">
				...
				<h6 style="text-align: left"><i class="fas fa-user"></i><?php echo " ".$row->Organization_Name;?></h6>
			</div>
			<div style="width: 20%; margin-left: 9%; float: left; display: inline-block;">
				...
				<h6 style="text-align: left"><i class="far fa-paper-plane"></i><?php echo " ".$row->O_Mail;?></h6>
			</div>
			<div style="display: inline-block; float: right;width: 20%; padding-right: 15%; padding-bottom: 3% ">
					<img src="<?php echo base_url();?>images\imagenes\nologo.png">
				</div>
		</div>
		...
		<div style="display: inline; width: 100%; margin-left: 20%;margin-right: 5%">
			...
			<?php echo form_open('Profile/profile_Business'); ?>
				...
				<div style="display: inline-block; width: 45%;padding-right: 5%">
					...
					<?php echo form_input(['name'=>'username', 'placeholder'=>'tu Nombre y Apellido', 'style'=>'width: 100%; border: none; height: 30px; border: 0.5px solid #ddd']);?><span style="color: red">
